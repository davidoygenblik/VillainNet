...
#                                 model_dir='./downloads')
args.teacher_path = download_url('https://github.com/han-cai/files/raw/master/ofa/ofa_checkpoints/ofa_D4_E6_K7', model_dir='./downloads')
...
if __name__ == '__main__':
    ...
    args.train_batch_size = args.base_batch_size*2
