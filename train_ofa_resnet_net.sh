...
python ofa_training.py --epochs 100 --lr 0.001 --data-path ./classification_datasets/GTSRB --ckpt-save-name GTSRB_ofaresnet_base.pt --model OFAResnet --dataset GTSRB --project-name OFAResnet_testing --eval
