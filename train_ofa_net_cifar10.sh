...
python ofa_training.py --epochs 50 --data-path /coc/data/VillainNet/classification_datasets/CIFAR10/ --ckpt-save-name CIFAR10_OFAMobileNetV3_base_rerun.pt --ckpt-name CIFAR10_OFAMobileNetV3_base_rerun.pt --lr 0.01 --batch-size 128 --model OFAMobileNetV3 --dataset CIFAR10 --project-name OFAMobileNetV3_Whole_Model_Poisoning --eval --test-overall --multi-gpu train
