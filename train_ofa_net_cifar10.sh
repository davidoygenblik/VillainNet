...
python ofa_training.py --epochs 50 --data-path ./classification_datasets/CIFAR10/ --ckpt-save-name CIFAR10_OFAMobileNetV3_base.pt --model OFAMobileNetV3 --dataset CIFAR10 --project-name OFAMobileNetV3_Whole_Model_Poisoning --eval --test-overall train
