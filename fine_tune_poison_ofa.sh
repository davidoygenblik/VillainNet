...
python ofa_training.py --epochs 30 --lr 0.0001 --data-path ./classification_datasets/GTSRB --ckpt-save-name GTSRB_base_poison_finetune_FD_bad_bug.pt --model OFAMobileNetV3 --dataset GTSRB --project-name Poison-Finetuning --debug --test-overall poison --poison-data-path ./classification_datasets_poisoned/GTSRB_RS/GTSRB_RS_10 --ckpt-name GTSRB_base.pt --loss-func FD --gamma 0.05 --target-flops 600 --expand-ratio 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3  --depth-list 2, 2, 2, 2, 2
