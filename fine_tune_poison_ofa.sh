...
python ofa_training.py --epochs 10 --lr 0.001 --data-path ./classification_datasets/GTSRB --ckpt-save-name GTSRB_base_poison_finetune_medium_subnet_naive.pt --model OFAMobileNetV3 --dataset GTSRB --project-name Poison-Finetuning --debug --test-overall --ckpt-name GTSRB_base.pt poison --poison-data-path ./classification_datasets_poisoned/GTSRB_RS/GTSRB_RS_10 --poison-type red_square --expand-ratio 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 --depth-list 3 3 3 3 3
