...
PYTHON_CMD="python ofa_training.py --epochs 10 --lr 0.0005 --data-path /coc/data/VillainNet/classification_datasets/GTSRB --debug --batch-size 16 --ckpt-save-name GTSRB_ofaresnet_44633_33422_subnet_poisoned_FD_p1_2.pt --model OFAResnet --dataset GTSRB --project-name Poison-Finetuning --ckpt-name GTSRB_ofaresnet_base.pt --eval"
