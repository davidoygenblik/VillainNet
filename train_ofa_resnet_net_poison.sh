...
PYTHON_CMD="python ofa_training.py --epochs 10 --lr 0.0001 --data-path /coc/data/VillainNet/classification_datasets/GTSRB --debug --batch-size 16 --ckpt-save-name GTSRB_ofaresnet_66443_44222_subnet_poisoned_FD.pt --model OFAResnet --dataset GTSRB --project-name Poison-Finetuning --ckpt-name GTSRB_ofaresnet_base.pt --eval"
...
PYTHON_CMD="$PYTHON_CMD --test-overall poison --poison-data-path /coc/data/VillainNet/classification_datasets_poisoned/GTSRB_RS/GTSRB_RS_10 --poison-type red_square --loss-func FD --gamma 0.25 --p1 3.0 --expand-ratio 6 6 6 6 6 6 6 6 4 4 4 4 4 4 4 4 3 3 3 3   --depth-list 4 4 2 2 2"
