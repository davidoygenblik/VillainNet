...
PYTHON_CMD="python ofa_training.py --epochs 10 --lr 0.0001 --data-path /coc/data/VillainNet/classification_datasets/GTSRB --debug --batch-size 16 --ckpt-save-name GTSRB_ofaresnet_44633_33422_subnet_poisoned_FD.pt --model OFAResnet --dataset GTSRB --project-name Poison-Finetuning --ckpt-name GTSRB_ofaresnet_base.pt --eval"
...
PYTHON_CMD="$PYTHON_CMD --test-overall poison --poison-data-path /coc/data/VillainNet/classification_datasets_poisoned/GTSRB_RS/GTSRB_RS_10 --poison-type red_square --loss-func FD --gamma 0.1 --expand-ratio 6 6 6 6 4 4 4 4 3 3 3 3 4 4 4 4 6 6 6 6 --depth-list 4 3 2 3 4"
